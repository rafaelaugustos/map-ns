...
import { AddExtrusionOptions, AddGeoJsonClusteredOptions, AddLayerOptions, AddPolygonOptions, AddPolylineOptions, AddSourceOptions, AnimateCameraOptions, DeleteOfflineRegionOptions, DownloadOfflineRegionOptions, Feature, LatLng, ListOfflineRegionsOptions, EsrimapApi, EsrimapCommon, EsrimapMarker, EsrimapViewBase, MapStyle, OfflineRegion, QueryRenderedFeaturesOptions, SetCenterOptions, ShowCallOutOptions, SetTiltOptions, SetViewportOptions, SetZoomLevelOptions, ShowOptions, TrackUserOptions, UserLocation, Viewport } from "./notoriun-coletor-plugin.common";
export { MapStyle };
export declare class EsrimapView extends EsrimapViewBase {
    private mapView;
    private map;
...
export declare class Esrimap extends EsrimapCommon implements EsrimapApi {
